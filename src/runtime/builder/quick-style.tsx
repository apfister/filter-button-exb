...
export class _QuickStyle extends React.PureComponent<OwnProps & ExtraProps, State> {
  ...
  render() {
    return (
      <Popper reference={this.props.reference} open={true} placement="right-start" container={document && document.body} offset={[20, 10]}
        css={this.getStyle(themeUtils.getBuilderThemeVariables())}
      >
        <h4 className="pt-3 pb-2 px-4">{this.translate('quickStyle')}</h4>

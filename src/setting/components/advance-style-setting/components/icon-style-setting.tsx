...
import {defaultMessages as jimuUIMessages, UnitTypes, LinearUnit} from 'jimu-ui';
...
export default class IconStyleSetting extends React.PureComponent<Props> {
  ...
  translate = (id: string) => {
    return this.props.intl ? this.props.intl.formatMessage({ id: id, defaultMessage: jimuUIMessages[id] }) : id;
  }

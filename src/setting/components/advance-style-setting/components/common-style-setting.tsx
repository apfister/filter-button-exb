...
import {BoxShadowSetting, BorderSetting, FourSides, BackgroundSetting} from 'jimu-ui/style-setting-components';
import {defaultMessages as jimuLayoutsMessages} from 'jimu-layouts/common';
  ...
  render() {
    ...
    return (
      <div className="common-style-setting">
        ...
        <div className="mb-3">
          <SettingRow label={this.props.intl.formatMessage({id: 'border', defaultMessage: jimuLayoutsMessages.border})} />
          <SettingRow>
            <BorderSetting value={style.border} onChange={this.updateBorder} />
          </SettingRow>
          <SettingRow label={this.props.intl.formatMessage({id: 'corner', defaultMessage: defaultMessages.corner})} flow="wrap">
